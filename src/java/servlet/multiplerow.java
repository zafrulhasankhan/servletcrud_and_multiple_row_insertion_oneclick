 ...
 */
@WebServlet(name = "multiplerow", urlPatterns = {"/multiplerow"})
public class multiplerow extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(multiplerow.class.getName()).log(Level.SEVERE, null, ex);
